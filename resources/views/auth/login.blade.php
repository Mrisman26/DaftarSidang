    ...
    <div class="w-full max-w-md bg-white shadow-xl rounded-lg p-8 relative">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center mb-6">
                ...
                <a class="ml-auto text-sm text-blue-500 hover:text-blue-600 hover:underline" href="{{ route('password.request') }}">
                    Lupa password?
                </a>
                @endif
            </div>
            ...
            <div class="mt-6 text-center text-gray-600 text-sm">
                Belum punya akun?
                <a href="{{ route('register') }}" class="text-blue-500 hover:text-blue-600 hover:underline">Daftar</a>
            </div>
        </form>
    </div>
