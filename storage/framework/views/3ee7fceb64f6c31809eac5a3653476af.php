<?php $__env->startSection('title', 'Edit Ruangan | SIPASTA'); ?>
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('ruangan.update', $ruangan->id)); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_ruangan" class="form-control" value="<?php echo e($ruangan->kode_ruangan); ?>" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="prodi_id" class="form-control">
                        ...
                        <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($prodi->id); ?>" <?php echo e($ruangan->prodi_id == $prodi->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('Template.Index', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Alip\Project\Daftar-Sidang\resources\views\ruangan\edit.blade.php ENDPATH**/ ?>