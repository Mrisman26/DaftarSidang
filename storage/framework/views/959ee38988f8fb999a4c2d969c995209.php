...
<body>
    ...
    <h3>Program Studi <?php echo e($mahasiswa->profile->prodi->nama_prodi ?? '-'); ?></h3>

    <p>Pada hari ini, <?php echo e(\Carbon\Carbon::parse($sidangSchedule->tanggal_sidang)->translatedFormat('l, d F Y')); ?>, pukul <?php echo e($sidangSchedule->jam_mulai); ?> s.d <?php echo e($sidangSchedule->jam_selesai); ?> WIB, telah dilaksanakan sidang tugas akhir dengan data sebagai berikut:</p>
    ...
    <table>
        ...
        <tr>
            <td>NIM</td>
            <td>: <?php echo e($mahasiswa->profile->nim ?? '-'); ?></td>
        </tr>
        <tr>
            <td>Judul</td>
            <td>: <?php echo e($sidangSchedule->judul ?? '-'); ?></td>
        </tr>
        <tr>
            <td>Ruang</td>
